...
- **Serverless Ready**: Deploy to AWS Lambda, Azure Functions, or Google Cloud Functions
- **Cold Start Optimized**: Minimized serverless cold start impact with connection pooling and resource caching
- **Multi-Cloud**: Platform-agnostic core with specialized adapters for each cloud provider
...
3. **Serverless Transport** (Cloud Function Mode):
   - Runs on **cloud provider infrastructure**
   - **Automatically scales** with request volume
   - **Pay-per-use** pricing model
   - Minimal operational overhead
   - Ideal for production deployments and variable workloads
...
For serverless deployment information, see:
- [Serverless Deployment Guide](docs/serverless-deployment.md) - Deploy to AWS, Azure, or GCP
- [Serverless Developer Guide](docs/serverless-developer-guide.md) - Architecture, development, and testing
